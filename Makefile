...
all: src/main.o src/structures.o src/ball.o src/collisions.o src/plateforme.o src/player.o src/ladder.o src/bonus.o src/shoot.o src/objets.o src/levels.o src/PCGfxEngine.o src/PCSoundEngine.o
	$(CC) -lSDL -lSDL_gfx -lSDL_mixer -lSDL_image -o $(TARGET) src/main.o src/structures.o src/ball.o src/collisions.o src/plateforme.o src/player.o src/ladder.o src/bonus.o src/shoot.o src/objets.o src/levels.o src/PCGfxEngine.o src/PCSoundEngine.o
...
clean:
	rm -rf src/*.o $(TARGET) *~ pang/pang.ipk
