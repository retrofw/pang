...
void loadSound(char *filenamePC,char *filenameDreamcast,int soundNumber)
{
     ...
     if (soundNumber==0)  sound0 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==1)  sound1 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==2)  sound2 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==3)  sound3 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==4)  sound4 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==5)  sound5 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==6)  sound6 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==7)  sound7 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==8)  sound8 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==9)  sound9 = Mix_LoadWAV(filenameDreamcast);
     else if (soundNumber==10)  sound10 = Mix_LoadWAV(filenameDreamcast);
...
{
     if ( (soundNumber==0) && (Mix_Playing(0)!=0) ) {Mix_HaltChannel(0);/*Mix_FreeChunk(sound0);*/soundUsed0=0;}
     else if ((soundNumber==1) && (Mix_Playing(1)!=0) ){Mix_HaltChannel(1);/*Mix_FreeChunk(sound1);*/soundUsed1=0;}
     else if ((soundNumber==2) && (Mix_Playing(2)!=0) ){Mix_HaltChannel(2);/*Mix_FreeChunk(sound2);*/soundUsed2=0;}
     else if ((soundNumber==3) && (Mix_Playing(3)!=0) ){Mix_HaltChannel(3);/*Mix_FreeChunk(sound3);*/soundUsed3=0;}
     else if ((soundNumber==4) && (Mix_Playing(4)!=0) ){Mix_HaltChannel(4);/*Mix_FreeChunk(sound4);*/soundUsed4=0;}
     else if ((soundNumber==5) && (Mix_Playing(5)!=0) ){Mix_HaltChannel(5);/*Mix_FreeChunk(sound5);*/soundUsed5=0;}
     else if ((soundNumber==6) && (Mix_Playing(6)!=0) ){Mix_HaltChannel(6);/*Mix_FreeChunk(sound6);*/soundUsed6=0;}
     else if ((soundNumber==7) && (Mix_Playing(7)!=0) ){Mix_HaltChannel(7);/*Mix_FreeChunk(sound7);*/soundUsed7=0;}
     else if ((soundNumber==8) && (Mix_Playing(8)!=0) ){Mix_HaltChannel(8);/*Mix_FreeChunk(sound8);*/soundUsed8=0;}
     else if ((soundNumber==9) && (Mix_Playing(9)!=0) ){Mix_HaltChannel(9);/*Mix_FreeChunk(sound9);*/soundUsed9=0;}
     else if ((soundNumber==10) && (Mix_Playing(10)!=0) ){Mix_HaltChannel(10);/*Mix_FreeChunk(sound10);*/soundUsed10=0;}
